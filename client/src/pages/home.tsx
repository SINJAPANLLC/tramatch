        ...
        {cargoListings && cargoListings.length > 0 && (
          <div className="relative">
            <style dangerouslySetInnerHTML={{ __html: `
              ...
              .listing-track-cargo{animation:listingScrollCargo ${Math.max(Math.min(cargoListings.length, 20) * 4, 20)}s linear infinite;}
              .listing-track-truck{animation:listingScrollTruck ${Math.max(Math.min((truckListings?.length || 0), 20) * 4, 20)}s linear infinite;}
